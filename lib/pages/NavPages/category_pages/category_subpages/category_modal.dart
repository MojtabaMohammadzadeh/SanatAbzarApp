  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 15,),
        Text('Title', style:TextStyle(fontSize: 30),textDirection: TextDirection.rtl,),
        SizedBox(height: 15,),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              IconButton(onPressed: (){}, icon: Icon(Icons.arrow_circle_left_outlined,size:50,)),
              IconButton(onPressed: (){}, icon: Icon(Icons.arrow_circle_right_outlined,size:50,)),
